...
/**
 * Tests for action flow interceptor with configuration.
 * 
 * @author Aleksandr Mashchenko
 * 
 */
@RunWith(Parameterized.class)
public class ActionFlowInterceptorConfTest extends
     ...
     *            Expected wrong order view action parameter value.
     */
    public ActionFlowInterceptorConfTest(final String suffix,
